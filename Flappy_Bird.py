...
#definindo o tipo e tamanho da fonte
pygame.font.init()
FONTE_PONTOS = pygame.font.SysFont('arial', 50)

#definindo as funcoes do jogo
#funcao passaro
class Passaro:
...
class Cano:
    ...
    # definindo a altura que o cano vai aparecer
